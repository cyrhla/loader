...
const ContainerNormalizer = require('../../Normalizer/ContainerNormalizer')

/**
 * ContainerNormalizerTest
 *
 * @author Krystian Pietruszka <kpietru@cyrhla.com>
 */
module.exports = class ContainerNormalizerTest extends Tester
{
    before()
    {
        this.obj = {}
    ...
    {
        var containerNormalizer = new ContainerNormalizer(this.obj)
        this.assertSame({}, containerXmlNormalizer.all())

        var parseObj = {"foo":"bar","baz":null}
        var containerXmlNormalizer = new ContainerXmlNormalizer(parseObj, this.attrKey, this.valueKey)
        this.assertSame({}, containerXmlNormalizer.all())

        var containerXmlNormalizer = new ContainerXmlNormalizer(this.parseObj, this.attrKey, this.valueKey)
...
/*
    ...
    {
        var containerXmlNormalizer = new ContainerXmlNormalizer(this.obj, this.attrKey, this.valueKey)
        var self = this
    ...
    test_normalizeArgumentInvalidTypeError()
    {
        ...
        for (let [index, arg] of args.entries()) {
            this.assertError('InvalidTypeError', function() {
                containerXmlNormalizer._normalize(arg, self.attrKey, self.valueKey)
            }, index)
        }
        ...
        for (let [index, arg] of args.entries()) {
            this.assertError('InvalidTypeError', function() {
                containerXmlNormalizer._normalize(self.obj, arg, self.valueKey)
            }, index)
        }
    ...
    test_normalizeIdAttributeReferenceError()
    {
        ...
        this.assertError('IdAttributeReferenceError', function() {
            containerXmlNormalizer._normalize(self.parseObjWithoutIdAttribute, self.attrKey, self.valueKey)
        })
    }
    ...
    testProcessArgumentInvalidTypeError()
    {
        ...
        for (let [index, arg] of args.entries()) {
            this.assertError('InvalidTypeError', function() {
                ContainerXmlNormalizer.process(arg, self.attrKey, self.valueKey)
            }, index)
        }
        ...
        for (let [index, arg] of args.entries()) {
            this.assertError('InvalidTypeError', function() {
                ContainerXmlNormalizer.process(self.obj, arg, self.valueKey)
            }, index)
        }
    ...
    testProcessIdAttributeReferenceError()
    {
        ...
        this.assertError('IdAttributeReferenceError', function() {
            ContainerXmlNormalizer.process(self.parseObjWithoutIdAttribute, self.attrKey, self.valueKey)
        })
    }
    ...
    testProcessMethodAttributeReferenceError()
    {
        ...
        this.assertError('MethodAttributeReferenceError', function() {
            ContainerXmlNormalizer.process(self.parseObjWithoutMethodAttribute, self.attrKey, self.valueKey)
        })
    }

    testProcessReturnsObject()
    {
        this.assertSame({}, ContainerXmlNormalizer.process({}, this.attrKey, this.valueKey))

        var parseObj = {"foo":"bar","baz":null}
        this.assertSame({}, ContainerXmlNormalizer.process(parseObj, this.attrKey, this.valueKey))

        this.assertSame(this.expected, ContainerXmlNormalizer.process(this.parseObj, this.attrKey, this.valueKey))
